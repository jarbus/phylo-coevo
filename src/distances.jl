...
function RelativeDistance(ind::Id,
    ...
    This function climbs the tree until the most recent ancestor between ind1 and rel1 is found. We avoid overshooting the most recent ancestor by climbing 
    """
    dist = Distance(0)
    while ind != rel
        ind == rel && return dist
